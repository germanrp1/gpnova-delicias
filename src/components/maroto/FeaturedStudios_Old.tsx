...
// 🚀 Importamos el render en MP4 que has guardado en assets
...
type Studio = {
  ...
  video?: string; // 🔑 Campo opcional para los renders en vídeo
};
...
const studios: Studio[] = [
  {
    ...
    video: v1, // 🎬 Asignamos el vídeo al Estudio Uno
  },
  {
    number: "03",
    title: "Estudio Tres",
    ...
    video: v3, // 🎬 Asignamos el vídeo al Estudio tres
  },
];
          ...
          {studios.map((s, i) => (
            ...
            >
              <div className="lg:col-span-7 grid grid-cols-3 gap-3">
                ...
                {/* 🚀 AQUÍ ESTÁ EL CAMBIO: El hueco pequeño de la derecha ahora decide si pone vídeo o foto */}
